...
namespace Proyecto_Final_Métodos_Númericos
{
    public partial class Form27 : Form
    {
        ...
        public Form27(string funcion) : this()
        {
        ...
        private void btnEvaluar_Click(object sender, EventArgs e)
        {
            ...
            // Convertir valores: si el TextBox está vacío, se toma como 0
        ...
        private void btnContinuar1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                using (var form29 = new Form29(lblResultado.Text, lblFuncionRecibida.Text, a0, a1, a2, a3, l1, l2))
                {
