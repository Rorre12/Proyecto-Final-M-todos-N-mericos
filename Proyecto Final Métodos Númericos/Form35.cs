    ...
    public partial class Form35 : Form
    {
        ...
        private void Form35_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                btnIngresar.Parent = mainPanel; btnRegresar.Parent = mainPanel;
            }
            catch { }
        ...
        private void mainPanel_Paint(object sender, PaintEventArgs e)
        {
            ...
            var c1 = VisualHelpers.ColorFromHSL(hue, 0.55f, 0.12f);
            var c2 = VisualHelpers.ColorFromHSL((hue + 90f) % 360f, 0.60f, 0.06f);
